              ...
              {allNavItems.map(item => {
                ...
                return (
                  ...
                  >
                    ...
                    {item.badge ? (
                      <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-rose-100 dark:bg-rose-500/20 text-rose-700 dark:text-rose-400 border border-rose-300 dark:border-rose-500/30">
                        {item.badge}
                      </span>
                    ) : null}
                  </button>
          ...
          if (item.isMain) {
            return (
              ...
              >
                ...
                <span className="text-[10px] font-bold text-brand-600 dark:text-brand-400 mt-0.5">Dispense</span>
              </button>
            );
          }
