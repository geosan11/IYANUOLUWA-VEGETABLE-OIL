-- ============================================================================
-- 0003_multi_hub.sql — Multi-Hub Architecture, Hub Scoping & Access Control
-- Depends on 0001_init.sql and 0002_auth_rls.sql.
-- ============================================================================

-- ---------------------------------------------------------------------------
-- 1. Extend user_role enum to include 'hub_manager'
-- ---------------------------------------------------------------------------
ALTER TYPE user_role ADD VALUE IF NOT EXISTS 'hub_manager';

-- ---------------------------------------------------------------------------
-- 2. Hubs table (Depots / Distribution Centres across Nigeria)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 3. Link operational tables and profiles to Hubs
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 5. Row Level Security for Hubs & Hub-Scoped Operational Records
-- ---------------------------------------------------------------------------
